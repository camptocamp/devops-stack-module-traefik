...
==== [[input_target_nodepool_id]] <<input_target_nodepool_id,target_nodepool_id>>

Description: ID of the target node pool.

Type: `string`

==== [[input_target_instance_pool_id]] <<input_target_instance_pool_id,target_instance_pool_id>>
...
|[[input_target_nodepool_id]] <<input_target_nodepool_id,target_nodepool_id>>
|ID of the target node pool.
|`string`
|n/a
|yes

|[[input_target_instance_pool_id]] <<input_target_instance_pool_id,target_instance_pool_id>>
|Instance pool ID of the target node pool.
|`string`
|n/a
|yes
